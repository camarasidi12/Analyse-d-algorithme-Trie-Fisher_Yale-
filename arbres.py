...
def printAbr(b):
	 if(len(b)==0):
		 ...
		 if(b.racine=="#"):
			return printAbr(b.fg)+printAbr(b.fd)
		 else:
			return printAbr(b.fg)+[b.racine]+printAbr(b.fd)
...
if __name__=='__main__' :
    ...
    l=ArbreBinaire(4,fils=(ArbreBinaire(3),Arbre(7)))
    d=ArbreBinaire(4,fils=(l,Arbre(7)))
    d.view()
    f=ArbreBinaire(4)
   # print(ar)
